...
namespace NetEx.Dialogs.WinForms.Interop
{
    ...
    internal interface IProgressDialog
    {
        ...
        /// <param name="punkEnableModless">Reserved. Set to <see langword="null"/>.</param>
        /// <param name="dwFlags">Flags that control the operation of the progress dialog box.</param>
        /// <param name="pvResevered">Reserved. Set to <see cref="IntPtr.Zero"/></param>
        ...
        uint StartProgressDialog(IntPtr hwndParent,                                             //HWND
                                 [MarshalAs(UnmanagedType.IUnknown)] object? punkEnableModless, //IUnknown
                                 uint dwFlags,                                                  //DWORD (PROGDLG Flags)
        ...
        [SuppressMessage("ReSharper", "CommentTypo")]
        void SetTitle([MarshalAs(UnmanagedType.LPWStr)] string pwzTitle //LPCWSTR
                     );
        /// <summary>
        ...
        /// <remarks><see cref="SetAnimation"/> cannot be called before the progress dialog is visible. Until it is displayed, the progress dialog does not have a valid HWND. The existence of that HWND can be used to determine whether <see cref="SetAnimation"/> can be called.
        ...
        [SuppressMessage("ReSharper", "CommentTypo")]
        void SetAnimation(IntPtr hInstAnimation, //HINSTANCE
        ...
        void SetProgress(uint dwCompleted, //DWORD
                         uint dwTotal      //DWORD
                        );
        /// <summary>
        /// Updates the progress dialog box with the current state of the operation.
        ...
        [SuppressMessage("ReSharper", "CommentTypo")]
        void SetProgress64(ulong ullCompleted, //ULONGLONG
        ...
        [SuppressMessage("ReSharper", "CommentTypo")]
        [SuppressMessage("ReSharper", "IdentifierTypo")]
        void SetLine(uint dwLineNum,                                           //DWORD
        ...
        [SuppressMessage("ReSharper", "CommentTypo")]
        [SuppressMessage("ReSharper", "IdentifierTypo")]
        void SetCancelMsg([MarshalAs(UnmanagedType.LPWStr)] string pwzCancelMsg,  //LPCWSTR
        ...
        [SuppressMessage("ReSharper", "CommentTypo")]
        [SuppressMessage("ReSharper", "IdentifierTypo")]
        void Timer(uint dwTimerAction,  //DWORD
                   object? pvResevered  //LPCVOID
                  );
    }
}